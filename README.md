...
## [Evolutionary Algorithms](https://github.com/nothingelsematters/evolutionary-algorithms)

![Rust]

- [Master's thesis experiments](https://github.com/nothingelsematters/evolutionary-algorithms)
...
- **Course structure**:
  ...
  - Scheduling
    ...
    - [B. O2 | | C_max](advanced-algorithms/kotlin/src/bO2CMax.kt)
    - [C. 1 | outree | Σ wi ci](advanced-algorithms/rust/src/scheduling/c_p1_outree_sum_wc.rs)
    - [D. 1 | | Σ Ui](advanced-algorithms/rust/src/scheduling/d_p1_sum_u.rs)
    - [E. 1 | pi = 1 | Σ wi Ui](advanced-algorithms/rust/src/scheduling/e_p1_sum_wu.rs)
    - [F. 1 | prec | f_max](advanced-algorithms/kotlin/src/fP1PrecFMax.kt)
    - [G. R2 | | C_max](advanced-algorithms/kotlin/src/gR2CMax.kt)
    - [H. 1 | prec; pmtn; ri | f_max](advanced-algorithms/kotlin/src/h1PrecPmtnRFMax.kt)
    - [J. P1 | p1 = 1 | Σ Ui](advanced-algorithms/kotlin/src/jP1P1SumU.kt)
    - [K. P2 | prec; pi = 1 | L_max](advanced-algorithms/rust/src/scheduling/k_p2_prec_p1_l_max.rs)
    - [L. P | intree; pi = 1 | L_max](advanced-algorithms/kotlin/src/lPIntreeP1LMax.kt)
    - [M. R | | Σ Ci](advanced-algorithms/cplusplus/m_r_sum_c.cpp)
    - [N. F2 | | C_max](advanced-algorithms/rust/src/scheduling/n_f2_c_max.rs)
    - [O. Q | | Σ Ci](advanced-algorithms/rust/src/scheduling/o_q_sum_c.rs)
...
- **Course structure**:
  - [Quick Sort](https://github.com/nothingelsematters/parallel-algorithms/tree/main/src/quick_sort)
  - [Breadth First Search](https://github.com/nothingelsematters/parallel-algorithms/tree/main/src/bfs)
...
- **Content**: writing a Lama compiler in [Lama language](https://github.com/JetBrains-Research/Lama)
- **Course structure**:
...
- **Course structure**:
  - [Codeforces tasks](machine-learning/small-tasks)
...
- **Course structure**:
  ...
  - [Course project GitHub database](databases/project):
    5 normal form normalization, ERM, PDM, DDL, DML, views, functions, triggers
...
- **Course structure**:
  ...
  - Homeworks
    - [Theoretical](functional-programming/hw0)
    - [Basic language constructions](functional-programming/hw1)
    - [File System Shell](functional-programming/hw2)
    - [Strictness. Multithreading. Advanced types. Lenses. Comonads.](functional-programming/hw3)
