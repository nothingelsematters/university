...
val KEY_BEGIN_PERMUTATION = listOf(
...
val KEY_END_PERMUTATION = listOf(
...
val POST_SBOX_PERMUTATION = listOf(
...
val KEY_SHIFT = listOf(1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, 21, 23, 25, 27, 28)

const val LONG_BYTES = Long.SIZE_BITS / Byte.SIZE_BITS
const val KEY_BLOCK_SIZE = 28
const val KEY_MAX_BLOCK = (1L shl KEY_BLOCK_SIZE) - 1L

const val BLOCK_SIZE = 8
const val BLOCK_BITS = BLOCK_SIZE * Byte.SIZE_BITS / 2

const val SBOX_SIZE = 6
const val POST_SBOX_SIZE = 4
