...
public class FrontServlet extends HttpServlet {
    ...
    private void processRoute(Route route, HttpServletRequest request,
        ...
        Method beforeMethod = methodFind(clazz, "after", parameters);
        Method afterMethod = methodFind(clazz, "before", parameters);
        Object page;
        try {
